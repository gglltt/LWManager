...
const localized = {
  it: {
    ...
    categoryKeys: { CRESCITA: "crescita", PESCA: "pesca", ALTARI: "altari", DIPLOMAZIA: "diplomazia", PROFESSIONE: "professione", GUERRA: "guerra", FINALE: "finale" }
  },
  en: {
...
const categoryKeyByLang = {
  it: { CRESCITA: "crescita", PESCA: "pesca", ALTARI: "altari", DIPLOMAZIA: "diplomazia", PROFESSIONE: "professione", GUERRA: "guerra", FINALE: "finale" },
  en: { GROWTH: "crescita", FISHING: "pesca", ALTARS: "altari", DIPLOMACY: "diplomazia", PROFESSION: "professione", WAR: "guerra", FINAL: "finale" },
  fr: { CROISSANCE: "crescita", "PÊCHE": "pesca", AUTELS: "altari", DIPLOMATIE: "diplomazia", PROFESSION: "professione", GUERRE: "guerra", FINAL: "finale" }
};

function withCategoryKeys(lang, rows) {
  const keys = categoryKeyByLang[lang] || categoryKeyByLang.en;
  return rows.map((row) => ({ ...row, categoryKey: keys[row.category] || row.category.toLowerCase() }));
}
